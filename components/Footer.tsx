    ...
    <footer className="bg-[#0f2456] py-16 px-5">
      <div className="max-w-6xl mx-auto">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            <div className="mb-4">
              ...
              >
                ...
                <span className="text-[#F47920]">2</span>
            ...
            <ul className="space-y-2.5">
              {[
                ...
                <li key={s}>
                  <a
                    href="#services"
                    className="text-blue-200/60 text-sm hover:text-[#F47920] transition-colors"
                  >
                    {s}
                  </a>
                </li>
            ...
            <ul className="space-y-4">
              <li>
                <a
                  ...
                  className="flex items-center gap-2.5 text-blue-200/60 text-sm hover:text-[#F47920] transition-colors"
                >
                  <svg
                    width="14"
                    height="14"
              ...
              <li>
                <a
                  ...
                  className="flex items-start gap-2.5 text-blue-200/60 text-sm hover:text-[#F47920] transition-colors break-all"
                >
                  <svg
                    width="14"
                    height="14"
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-blue-200/40">
          <p>
            &copy; {year} Company2You. All rights reserved.
          </p>
          <p>
            Companionship &amp; Befriending Service &middot; Rainford &amp;
            West Lancashire
          </p>
